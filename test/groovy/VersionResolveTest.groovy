...
class VersionResolveTest extends BaseTest {
    ...
    void 'release branches get an rc suffix'() {
        assertThat(step('versionResolve').call('release/1.4')).isEqualTo('1.4.0-rc.42')
    }

    @Test
    void 'hotfix branches carry the sha'() {
        assertThat(step('versionResolve').call('hotfix/urgent')).isEqualTo('1.4.0-hotfix.42.gab12cd3')
    }

    @Test
    void 'feature branches are slugified'() {
        assertThat(step('versionResolve').call('feature/Add_Login-Page'))
