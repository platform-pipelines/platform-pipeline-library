...
([logActor](../utilities/logActor.md)) when there was no approval gate.
...
Reads the current manifest via [githubFetchFile](../github-slack/githubFetchFile.md),
rewrites it with [manifestBumpImage](manifestBumpImage.md), and commits via
[githubCommitFile](../github-slack/githubCommitFile.md). Called from
[deployGitops](deployGitops.md).
