...
Decides which image tag a [cdPipeline](../pipelines/cdPipeline.md) run deploys: an explicit
...
|---|---|
| `gitops` | [githubFetchFile](../github-slack/githubFetchFile.md) of the source `manifestPath`, then [manifestCurrentImage](manifestCurrentImage.md) |
