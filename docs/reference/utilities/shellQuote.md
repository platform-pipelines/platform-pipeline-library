...
!!! note "Use this anywhere a config-controlled value reaches `sh`"
    ...
    [`githubApiRequest`](../github-slack/githubApiRequest.md), [`githubFetchFile`](../github-slack/githubFetchFile.md),
    [`assumeAwsRole`](../infrastructure/assumeAwsRole.md), and [`cfnChangeSet`](../infrastructure/cfnChangeSet.md)
