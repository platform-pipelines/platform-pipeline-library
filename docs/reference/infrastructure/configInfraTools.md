...
| Trivy scan | [scanTrivy](../quality/scanTrivy.md) (`fs`) | [scanIac](../quality/scanIac.md) (`trivy config`) |
| Artifact publish | [publishArtifact](../deploy/publishArtifact.md) | skipped |
...
[`configLoad`](../config/configLoad.md) to derive the values above, and by
[`configValidate`](../config/configValidate.md) to reject
