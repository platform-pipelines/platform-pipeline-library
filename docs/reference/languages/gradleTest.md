...
| `build/reports/jacoco/test/jacocoTestReport.xml` | [checkCoverage](../quality/checkCoverage.md), Sonar |
...
Called by [testApp](../pipelines/testApp.md) when `cfg.buildTool == 'gradle'`.
