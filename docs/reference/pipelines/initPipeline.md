...
|---|---|---|---|---|
| `overrides` | `Map` | yes (may be `[:]`) | — | Inline config overrides, passed to [`configLoad`](../config/configLoad.md). May include `configFile`. |
...
| `quality.*`, `lint.*`, `environments` | see [configDefaults](../config/configDefaults.md) | | Printed in the build summary line. |
...
| `env.APP_VERSION` | `1.4.0` | [versionResolve](../utilities/versionResolve.md) |
| `env.IMAGE_TAG` | `1.4.0` | [versionImageTag](../utilities/versionImageTag.md) |
| `env.GIT_SHORT_SHA` | `ab12cd3` | [versionShortSha](../utilities/versionShortSha.md) |
