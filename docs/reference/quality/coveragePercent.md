...
|---|---|---|---|---|
| `cfg` | `Map` | yes | — | Pipeline config; `buildTool` locates the report via [appCoverageFile](../pipelines/appCoverageFile.md). |
...
via [useScript](../utilities/useScript.md), not in Groovy. Used by
