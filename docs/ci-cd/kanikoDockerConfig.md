...
| `123456789012.dkr.ecr.eu-west-1.amazonaws.com/api` | the ECR host | user `AWS`, password from `aws ecr get-login-password --region eu-west-1` under [withAwsCredentials](../cloud/withAwsCredentials.md) |
