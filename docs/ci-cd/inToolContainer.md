...
| Step | Image |
|---|---|
| [scanTrivy](scanTrivy.md), [scanIac](scanIac.md), [generateSbom](generateSbom.md) | `aquasec/trivy:latest` |
| [scanSecrets](scanSecrets.md) | `zricethezav/gitleaks:latest` |
| [scanSonar](scanSonar.md) | `sonarsource/sonar-scanner-cli:latest` |
| [argoSync](../cloud/argoSync.md) | `quay.io/argoproj/argocd:latest` |
